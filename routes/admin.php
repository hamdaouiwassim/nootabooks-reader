...
Route::middleware('auth:admin')->group(function () {
    ...
    Route::get('/books/bulk-covers', [BookController::class, 'bulkCovers'])->name('books.bulk-covers');
    Route::post('/books/bulk-covers', [BookController::class, 'storeBulkCovers'])->name('books.bulk-covers.store');
