        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:420px; background:#ffffff; border-radius:14px; overflow:hidden; border:1px solid #eae4d6;">
          ...
          <tr>
            <td style="padding:28px;">
              <p style="margin:0 0 8px; font-size:15px; color:#1f2d2b;">مرحبًا <?php echo e($admin->name); ?>،</p>
              ...
              <p style="margin:0 0 6px; font-size:13px; color:#8a9490;">
                هذا الرمز صالح لمدة <?php echo e($expiresInMinutes); ?> دقائق فقط.
              </p>
...
<?php /**PATH C:\Users\USER\Desktop\nootabooksui-reader\resources\views/admin/emails/admin-login-code.blade.php ENDPATH**/ ?>