<?php $__env->startSection('title', 'تعديل المؤلف: '.$writer->name.' - مكتبتي'); ?>
...
<div class="admin-page-head">
  <div>
    <h1>تعديل المؤلف: <?php echo e($writer->name); ?></h1>
...
<form id="writerForm" method="POST" action="<?php echo e(route('admin.writers.update', $writer)); ?>" enctype="multipart/form-data" novalidate>
  <?php echo csrf_field(); ?>
  ...
  <div class="admin-form-layout">
    ...
    <div>
      <div class="admin-form-section">
        ...
        <div class="admin-form-grid">
          <div class="admin-form-field full">
            ...
            <input type="text" id="writerName" name="name" class="admin-input" value="<?php echo e(old('name', $writer->name)); ?>" required>
          </div>
          <div class="admin-form-field">
            <label for="writerGenre">التصنيف الأدبي</label>
            <input type="text" id="writerGenre" name="genre_tag" class="admin-input" value="<?php echo e(old('genre_tag', $writer->genre_tag)); ?>">
          </div>
          <div class="admin-form-field">
            <label for="writerJoined">نشط منذ (سنة)</label>
            <input type="number" id="writerJoined" name="joined_year" class="admin-input" value="<?php echo e(old('joined_year', $writer->joined_year)); ?>" min="1900" max="2100">
          </div>
          <div class="admin-form-field full">
            <label for="writerBio">نبذة تفصيلية</label>
            <textarea id="writerBio" name="bio" class="admin-textarea" rows="6"><?php echo e(old('bio', $writer->bio)); ?></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="admin-form-section">
        ...
        <div class="admin-form-grid">
          <div class="admin-form-field">
            ...
            <input type="number" id="writerFollowers" name="followers_count" class="admin-input" value="<?php echo e(old('followers_count', $writer->followers_count)); ?>" min="0">
          </div>
          <div class="admin-form-field">
            <label for="writerRating">متوسط التقييم (0-5)</label>
            <input type="number" id="writerRating" name="rating_average" class="admin-input" value="<?php echo e(old('rating_average', $writer->rating_average)); ?>" min="0" max="5" step="0.1">
          </div>
        </div>
        <div class="admin-toggle-row" style="margin-top:16px;">
          ...
          <label class="admin-switch">
            <input type="checkbox" name="is_featured" value="1" <?php if(old('is_featured', $writer->is_featured)): echo 'checked'; endif; ?>>
      ...
      <div class="admin-form-section">
        <h3>كتب هذا المؤلف (<?php echo e($writer->books_count); ?>)</h3>
            ...
            <tbody>
              <?php $__empty_1 = true; $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                  ...
                  <td>
                    <a href="<?php echo e(route('admin.books.edit', $book)); ?>" class="admin-icon-btn" title="تعديل الكتاب" aria-label="edit"><i class="fa-solid fa-pen"></i></a>
                  </td>
                </tr>
    ...
    <div>
      <div class="admin-form-section">
        ...
        <label class="admin-cover-upload <?php if($writer->photo): ?> has-image <?php endif; ?>" id="coverUpload" style="aspect-ratio:1/1;">
          <i class="fa-solid fa-user"></i>
          <span>اضغط لرفع صورة المؤلف<br>(JPG أو PNG، مربعة الشكل)</span>
          <img id="coverPreview" <?php if($writer->photo): ?> src="<?php echo e($writer->photo_url); ?>" <?php else: ?> hidden <?php endif; ?> alt="معاينة الصورة">
        </label>
