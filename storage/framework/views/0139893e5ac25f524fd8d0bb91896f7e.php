...
<div class="error-page">
  ...
  <div class="error-actions">
    ...
    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline"><i class="fa-solid fa-arrow-right-to-bracket"></i> تسجيل الدخول</a>
  </div>

  <p class="error-footer-note">تعتقد أن هذا خطأ؟ <a href="<?php echo e(route('contact')); ?>">تواصل مع الدعم</a></p>
</div>

<script src="<?php echo e(asset('assets/js/script.js')); ?>"></script>
</body>
</html>
<?php /**PATH C:\Users\USER\Desktop\nootabooksui-reader\resources\views/errors/403.blade.php ENDPATH**/ ?>