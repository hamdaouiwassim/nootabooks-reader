      ...
      <?php $__currentLoopData = $trendingBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <article class="book-card">
          <?php if($book->cover_image): ?>
            <img class="book-cover cover-photo" src="<?php echo e(asset($book->cover_image)); ?>" alt="<?php echo e($book->title); ?>">
          <?php else: ?>
          ...
          <a href="<?php echo e(route('book-details', $book->slug)); ?>" class="btn btn-outline"><i class="fa-solid fa-eye"></i> شاهد</a>
        </article>
