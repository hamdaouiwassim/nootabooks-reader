...
class Advertisement extends Model
{
    ...
    public const array ZONES = [
        ...
        'book_details_top' => 'أعلى صفحة تفاصيل الكتاب (قبل بيانات الكتاب)',
        'book_details_before_tabs' => 'وسط صفحة تفاصيل الكتاب (قبل التبويبات)',
    ...
    protected $fillable = [
        ...
        'zone',
        'creative_path',
        'creative_path_tablet',
        'creative_path_mobile',
        'target_url',
        'heading',
        'body_text',
        'alt_text',
    ...
    /**
     * The desktop/default creative — for animated_banner this is the only
     * image that ever exists (no per-device uploads for GIFs). For the two
     * static types it's the admin's desktop upload, and also the fallback
     * shown on tablet/mobile whenever they didn't upload a device-specific
     * image for this ad.
     */
    ...
    protected function creativeTabletUrl(): Attribute
    {
        return Attribute::make(get: fn () => $this->resolveFileUrl($this->creative_path_tablet) ?? $this->creative_url);
    }

    protected function creativeMobileUrl(): Attribute
    {
        return Attribute::make(get: fn () => $this->resolveFileUrl($this->creative_path_mobile) ?? $this->creative_url);
    }
