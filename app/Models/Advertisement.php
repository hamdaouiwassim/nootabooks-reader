...
class Advertisement extends Model
{
    ...
    /**
     * Desktop-size creative. For image_banner/image_text this is the base
     * variant generated by ImageOptimizer::optimizeResponsive() alongside
     * -md/-sm siblings (see AdvertisementController::storeCreative()). For
     * animated_banner there are no size variants at all — only ever this
     * one file — since resizing would mean re-encoding, which is exactly
     * what would destroy the animation.
     */
    ...
    protected function creativeMdUrl(): Attribute
    {
        return Attribute::make(get: fn () => $this->resolveVariantUrl($this->creative_path, 'md'));
    }

    protected function creativeSmUrl(): Attribute
    {
        return Attribute::make(get: fn () => $this->resolveSmallVariantUrl($this->creative_path));
    }
