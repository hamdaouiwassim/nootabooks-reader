...
class StoreBookRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cover_image_md' => ['nullable', 'image', 'max:4096'],
            'cover_image_sm' => ['nullable', 'image', 'max:4096'],
    ...
    public function messages(): array
    {
        return [
            ...
            'seo_title.max' => 'عنوان السيو طويل جدًا (الحد الأقصى 255 حرفًا).',
            'seo_description.max' => 'وصف السيو طويل جدًا (الحد الأقصى 500 حرف).',
            ...
            'cover_image_md.image' => 'يجب أن يكون الغلاف المتوسط ملف صورة (JPG أو PNG).',
            'cover_image_md.max' => 'حجم الغلاف المتوسط يجب ألا يتجاوز 4 ميجابايت.',
            'cover_image_sm.image' => 'يجب أن يكون الغلاف الصغير ملف صورة (JPG أو PNG).',
            'cover_image_sm.max' => 'حجم الغلاف الصغير يجب ألا يتجاوز 4 ميجابايت.',
            'book_file.file' => 'يجب رفع ملف صالح للكتاب.',
            'book_file.mimes' => 'صيغة ملف الكتاب غير مدعومة، يجب أن يكون بصيغة PDF.',
