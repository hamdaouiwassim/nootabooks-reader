...
class StoreBookRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'translator_name.max' => 'اسم المترجم طويل جدًا (الحد الأقصى 255 حرفًا).',
            'category_id.required' => 'يجب اختيار تصنيف للكتاب.',
            'category_id.exists' => 'التصنيف المحدد غير موجود.',
            'categories.*.exists' => 'أحد التصنيفات الإضافية المحددة غير موجود.',
            'series_name.max' => 'اسم السلسلة طويل جدًا (الحد الأقصى 255 حرفًا).',
            'series_order.integer' => 'رقم الجزء يجب أن يكون رقمًا صحيحًا.',
            'series_order.min' => 'رقم الجزء يجب أن يكون 1 أو أكبر.',
