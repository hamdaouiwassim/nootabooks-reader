...
class StoreAdvertisementRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'creative_tablet' => ['nullable', 'image', 'max:8192'],
            'creative_mobile' => ['nullable', 'image', 'max:8192'],
    ...
    public function messages(): array
    {
        return [
            ...
            'creative.required' => 'يجب رفع ملف الإعلان.',
            'creative.max' => 'حجم ملف الإعلان يجب ألا يتجاوز 8 ميجابايت.',
            'creative_tablet.image' => 'يجب أن تكون صورة الأجهزة اللوحية ملف صورة صالح.',
            'creative_tablet.max' => 'حجم صورة الأجهزة اللوحية يجب ألا يتجاوز 8 ميجابايت.',
            'creative_mobile.image' => 'يجب أن تكون صورة الجوال ملف صورة صالح.',
            'creative_mobile.max' => 'حجم صورة الجوال يجب ألا يتجاوز 8 ميجابايت.',
