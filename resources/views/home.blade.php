...
@section('title', 'اكتشف الكتب والروايات واقرأها وحمّلها أونلاين | نوتابوكس')
@section('meta_description', 'اكتشف الكتب والروايات العربية والمترجمة على نوتابوكس، وابحث عن الكتب حسب المؤلف والتصنيف واستكشف ما يناسب اهتماماتك واقرأه أونلاين.')
...
<section class="hero" aria-labelledby="hero-heading">
  <img class="hero-background" src="{{ asset('assets/images/hero-section.jpg') }}"
    srcset="{{ asset('assets/images/hero-section-sm.webp') }} 746w, {{ asset('assets/images/hero-section.jpg') }} 1342w"
