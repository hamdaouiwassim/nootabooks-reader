...
@section('title', 'مجتمع القراء والكتب والروايات | نوتابوكس')
@section('meta_description', 'انضم إلى مجتمع القراء على نوتابوكس، ناقش الكتب والروايات، شارك آراءك وتوصياتك وتواصل مع قراء يشاركونك شغف القراءة.')
    ...
    <div class="discussion-feed" id="discussionFeed">
      ...
      @empty
        <div class="no-results">
          ...
          @endif
          <p>كن أول من يبدأ النقاش — شارك رأيك حول كتاب قرأته وابدأ أول حوار في مجتمع نوتابوكس.</p>
        </div>
      @endforelse
    ...
    <div class="sidebar-card">
      ...
      @empty
        <div class="no-results">
          ...
          <p>شارك في أول نقاش أو أنشئ نادي قراءة لتصبح من أوائل المساهمين في مجتمع نوتابوكس.</p>
        </div>
      @endforelse
    </div>
