...
@section('title', 'تصنيفات الكتب والروايات العربية والمترجمة | نوتابوكس')
@section('meta_description', 'تصفح تصنيفات الكتب والروايات العربية والمترجمة على نوتابوكس، من الروايات والأدب إلى التاريخ والتكنولوجيا والتنمية الذاتية وغيرها من المجالات.')
