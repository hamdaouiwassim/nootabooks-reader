...
@section('title', 'الفيل الأزرق - نوته بوك')
...
<section class="section book-hero">
  ...
  <div class="book-hero-info">
    ...
    <p class="book-author">تأليف <a href="{{ route('writer-details', 'ahmed-mourad') }}">أحمد مراد</a></p>
...
<section class="section tabs-section">
  ...
  <div class="tab-panel" id="tab-reviews">
    ...
    @auth
      <form method="POST" action="{{ route('reviews.store', $currentBook->slug ?? 'blue-elephant') }}" class="add-review-form" id="addReviewForm" hidden>
        @csrf
  ...
  <div class="tab-panel" id="tab-author">
    <div class="author-mini-card">
      ...
      <div class="author-mini-info">
        <h3><a href="{{ route('writer-details', 'ahmed-mourad') }}">أحمد مراد</a></h3>
      ...
      @auth
        <form method="POST" action="{{ route('writers.follow', $bookAuthorSlug) }}">
          @csrf
...
@push('scripts')
<script src="{{ asset('assets/js/book-details.js') }}"></script>
@endpush
