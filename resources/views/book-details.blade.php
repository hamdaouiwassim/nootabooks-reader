    ...
    @if ($currentBook->copyright_blocked)
      <div class="copyright-block-notice">
        ...
        <div>
          ...
          <p>تحرص منصة نوتابوكس على احترام حقوق المؤلفين والناشرين، وتلتزم بإزالة أو تقييد الوصول إلى أي محتوى بناءً على طلب أصحاب الحقوق، دعمًا لحماية الملكية الفكرية وتشجيعًا على نشر المحتوى بصورة قانونية ومسؤولة.</p>
        </div>
      </div>
    @endif
...
<section class="section tabs-section">
  ...
  <div class="tab-panel active" id="tab-about">
    ...
    <section aria-labelledby="online-reading" style="margin-top:22px;">
      ...
      @if ($currentBook->is_coming_soon)
        <p>سيتوفر {{ $currentBook->type_label }} {{ $currentBook->title }} للقراءة أونلاين على نوتابوكس قريبًا.</p>
      @elseif ($currentBook->copyright_blocked)
      ...
      @else
        <p>يمكنك قراءة {{ $currentBook->title }} أونلاين مباشرة من خلال قارئ الكتب في نوتابوكس، دون الحاجة لتحميل أي برنامج إضافي.</p>
