      ...
      <div class="admin-form-section">
        ...
        <div class="admin-form-grid">
          ...
          <div class="admin-form-field">
            ...
            <input type="text" id="bookTranslatorName" name="translator_name" class="admin-input" value="{{ old('translator_name', $book->translator_name) }}" placeholder="مثال: أحمد محمود">
          ...
          <div class="admin-form-field">
            ...
            @endphp
            <input type="text" id="bookSeriesName" name="series_name" list="seriesDatalist" class="admin-input" value="{{ old('series_name', $book->series?->name) }}" placeholder="مثال: ثلاثية الأرض" data-series-map="{{ json_encode($seriesAutoFillMap, JSON_UNESCAPED_UNICODE) }}">
            <datalist id="seriesDatalist">
              @foreach ($allSeries as $series)
                <option value="{{ $series->name }}">
              @endforeach
            </datalist>
            <span class="hint">اكتب اسم سلسلة موجودة لربط الكتاب بها، أو اسمًا جديدًا لإنشاء سلسلة جديدة، أو اترُكه فارغًا لإلغاء الربط — سيُستخدم نفس مؤلف وتصنيف السلسلة تلقائيًا</span>
          </div>
          <div class="admin-form-field">
