...
<form id="bookForm" method="POST" action="{{ route('admin.books.store') }}" enctype="multipart/form-data" novalidate>
  ...
  <div class="admin-form-layout">
    ...
    <div>
      ...
      @include('admin.books._faqs-section')
      ...
      <div class="admin-form-section">
        ...
        <div class="admin-toggle-row" style="margin-top:16px;">
          ...
          <label class="admin-switch">
            <input type="checkbox" name="reading_disabled" value="1" @checked(old('reading_disabled'))>
            <span class="admin-switch-slider"></span>
          </label>
        </div>
        <div class="admin-toggle-row" style="margin-top:16px; background:#fdecea; border:1px solid #f3c7c1; border-radius:10px; padding:14px;">
          ...
          <label class="admin-switch">
            <input type="checkbox" name="copyright_blocked" value="1" @checked(old('copyright_blocked'))>
            <span class="admin-switch-slider"></span>
          </label>
        </div>
      </div>
