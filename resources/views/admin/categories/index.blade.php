...
<div class="admin-categories-grid" id="categoriesGridBody">
  ...
  @foreach ($categories as $category)
    <div class="admin-category-card" data-cat-id="{{ $category->id }}" data-cat-name="{{ $category->name }}" data-cat-color="{{ $category->color ?? 'cat-navy' }}">
  ...
  <div class="admin-modal form-modal">
    ...
    <form id="categoryForm">
      ...
      <div class="admin-category-preview-row">
        <span class="cat-icon-circle cat-navy" id="categoryPreview"></span>
      </div>
...
@push('scripts')
<script src="{{ asset_min('assets/js/categories-admin.js') }}" defer></script>
@endpush
