        ...
        <tr>
          <td>
            <div class="admin-book-cell">
              @if ($user->avatar)
                <img class="admin-book-cover" style="border-radius:50%; width:44px; height:44px;" src="{{ asset($user->avatar) }}" width="44" height="44" loading="lazy" decoding="async" alt="{{ $user->name }}">
              @else
