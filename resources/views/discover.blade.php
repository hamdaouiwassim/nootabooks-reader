...
@section('title', 'اكتشف الكتب والروايات العربية والمترجمة | نوتابوكس')
@section('meta_description', 'اكتشف الكتب والروايات العربية والمترجمة في مختلف المجالات. ابحث حسب العنوان أو المؤلف والتصنيف واللغة واستكشف الكتب المتاحة على نوتابوكس.')
...
<section class="section discover-seo-note">
  ...
  <p>
    يتيح لك نوتابوكس استكشاف مجموعة متنوعة من الكتب والروايات العربية والمترجمة
    @if ($categories->isNotEmpty())
